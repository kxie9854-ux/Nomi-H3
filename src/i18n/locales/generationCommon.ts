export const zhGenerationCommon = {
  ...
  canvas: {
    ...
    empty: {
      ...
      directorTitle: '说一个想法，开始导演成片',
      directorDescription: '右侧 Codex 会一步步确认画幅、时长和镜头，再往画布上落静帧与视频。',
      startDirector: '开始导演',
      startDirectorAria: '打开 Codex 导演，说出成片想法',
      createManual: '手动建{{category}}',
    ...
    assistantSuffix: '生成',
    codexAssistantSuffix: 'Codex',
    minimapAria: '画布缩略导航',
    tidied: '已整理 · ⌘Z 撤销',
  },
  codex: {
    needLogin: '未登录 ChatGPT 套餐',
    login: '登录 ChatGPT',
    setup: {
      stills: 'Codex 生图',
      video: 'AutoDL.art MiniMax H3',
      join: '、',
      body: '还差 {{missing}}。配好后再说想法，导演就能出静帧和视频。',
      openModels: '去配置模型',
    },
    switchNomi: 'Nomi 助手',
    moreActions: '更多',
    collapse: '收起 Codex',
    empty: '说一个想法，我会一步步确认再往画布上落成片。选中镜头可改这一镜。付费仍在 Nomi 确认。',
    placeholder: '例如：晨光花园里的小猫追蝴蝶',
    placeholderNone: '例如：只改这一张卡的提示词',
    placeholderAuthor: '例如：把古装衙门调度写成导演技能',
    placeholderSelected: '改这镜更暖一点，或换参考再出一条',
    selectionHint: '将改选中的 {{count}} 个镜头',
    send: '发给 Codex',
    stop: '停止',
    spendTitle: '确认消耗模型额度',
    actionTitle: '确认 Codex 操作',
    confirmGenerate: '确认生成',
    confirmContinue: '确认继续',
    cancelGenerate: '取消',
    confirmationExpired: '这次确认已失效，请让 Codex 重新发起生成。',
    confirmationFallback: 'Nomi 需要你的确认后才能继续。',
    unsupportedRequest: '当前版本暂不支持 Codex 请求：{{method}}',
    unavailable: '当前窗口没有桌面桥，内嵌 Codex 只能在 Nomi 应用里用。',
    restore: {
      ready: '已恢复这个项目',
      loading: '正在恢复这个项目的导演记录…',
      error: '旧对话暂时没有取回。你仍可直接发送新指令继续制作。',
      truncated: '较早对话已省略',
      userLabel: '你',
      assistantLabel: 'Codex',
      summary: {
        brief: '{{nodeCount}} 个画布节点 · {{aspectRatio}}',
        stills: '{{completedImageCount}} 张静帧已就绪 · {{nodeCount}} 个画布节点 · {{aspectRatio}}',
        confirm: '{{completedImageCount}} 张静帧已就绪 · 等待确认 · {{aspectRatio}}',
        render: '{{completedVideoCount}} 个镜头已出视频 · 时间轴 {{timelineDuration}} · {{aspectRatio}}',
        film: '{{completedVideoCount}} 个镜头已成片 · 时间轴 {{timelineDuration}} · {{aspectRatio}}',
      },
      next: {
        brief: '接下来：说出成片想法，我会先确认画幅、时长与声音。',
        stills: '接下来：先确认角色、场景与关键帧，再进入视频生成。',
        confirm: '接下来：确认静帧后，再提交付费视频生成。',
        render: '接下来：审看已出视频，把满意的镜头排入时间轴。',
        film: '接下来：做最终审片，满意后即可导出。',
      },
    },
    stageAria: '制作阶段',
    stage: {
    ...
    skill: {
      ...
      modeAria: '技能模式',
      spine: '成片',
      mode: { none: '无技能', film: '成片', author: '创建技能' },
      import: '导入',
      importAria: '导入 SKILL.md',
      importFailed: '没能导入这个技能',
      emptyImport: '请选择一份 SKILL.md',
      pickerHint: '点选模板叠到成片导演上，最多 3 个。',
      pickerHintNone: '不套成片流程。仍只用 AutoDL.art H3 和 Codex 生图。',
      pickerHintAuthor: '这轮只写导演技能。保存后切回成片再点芯片。不要出视频。',
      templates: {
        'director-guzhuang': '古装',
        'director-cinematography': '运镜',
        'director-performance': '表演',
        'director-sound': '声音',
        'director-action': '动作',
        'director-art-design': '美术',
        'director-staging': '调度',
        'director-consistency': '一致性',
        'director-transitions': '转场',
...
export const enGenerationCommon = {
  ...
  canvas: {
    ...
    empty: {
      ...
      directorTitle: 'Say an idea and start directing the film',
      directorDescription: 'Codex on the right will confirm aspect, duration, and shots, then land stills and video on the canvas.',
      startDirector: 'Start directing',
      startDirectorAria: 'Open the Codex director and describe the film',
      createManual: 'Create a {{category}} node manually',
  ...
  codex: {
    needLogin: 'ChatGPT account not signed in',
    login: 'Sign in with ChatGPT',
    setup: {
      stills: 'Codex imagegen',
      video: 'AutoDL.art MiniMax H3',
      join: ' and ',
      body: 'Still needed: {{missing}}. Connect them, then describe an idea to land stills and video.',
      openModels: 'Open model setup',
    },
    switchNomi: 'Nomi assistant',
    moreActions: 'More',
    collapse: 'Collapse Codex',
    empty: 'Say a simple idea. I will confirm each step, then land the film on the canvas. Select a shot to iterate it. Paid submits still confirm in Nomi.',
    placeholder: 'e.g. a kitten chasing a butterfly in a morning garden',
    placeholderNone: 'e.g. rewrite the prompt on this card only',
    placeholderAuthor: 'e.g. turn yamen staging rules into a director skill',
    placeholderSelected: 'Make this shot warmer, or swap refs and regenerate',
    selectionHint: 'Will edit {{count}} selected shot(s)',
    send: 'Send to Codex',
    stop: 'Stop',
    spendTitle: 'Confirm model credit spend',
    actionTitle: 'Confirm Codex action',
    confirmGenerate: 'Confirm generation',
    confirmContinue: 'Confirm and continue',
    cancelGenerate: 'Cancel',
    confirmationExpired: 'This confirmation has expired. Ask Codex to start the generation again.',
    confirmationFallback: 'Nomi needs your confirmation before it can continue.',
    unsupportedRequest: 'This version does not support the Codex request: {{method}}',
    unavailable: 'The desktop bridge is missing. The embedded Codex panel only works inside the Nomi app.',
    restore: {
      ready: 'Project restored',
      loading: 'Restoring this project’s director history…',
      error: 'The earlier conversation could not be restored. You can still send a new instruction and continue.',
      truncated: 'Earlier conversation omitted',
      userLabel: 'You',
      assistantLabel: 'Codex',
      summary: {
        brief: '{{nodeCount}} canvas node(s) · {{aspectRatio}}',
        stills: '{{completedImageCount}} still(s) ready · {{nodeCount}} canvas node(s) · {{aspectRatio}}',
        confirm: '{{completedImageCount}} still(s) ready · awaiting approval · {{aspectRatio}}',
        render: '{{completedVideoCount}} shot(s) rendered · timeline {{timelineDuration}} · {{aspectRatio}}',
        film: '{{completedVideoCount}} shot(s) in the film · timeline {{timelineDuration}} · {{aspectRatio}}',
      },
      next: {
        brief: 'Next: describe the film; I will confirm aspect ratio, duration, and sound first.',
        stills: 'Next: approve the character, scene, and keyframes before video generation.',
        confirm: 'Next: approve the stills before submitting paid video generation.',
        render: 'Next: review the rendered shots and assemble the keepers on the timeline.',
        film: 'Next: run the final review, then export when it looks right.',
      },
    },
    stageAria: 'Production stage',
    stage: {
      brief: 'Brief',
      stills: 'Stills',
      confirm: 'Confirm',
    ...
    skill: {
      aria: 'Director templates',
      modeAria: 'Skill mode',
      spine: 'Film',
      mode: { none: 'No skill', film: 'Film', author: 'Create skill' },
      import: 'Import',
      importAria: 'Import SKILL.md',
      importFailed: 'Could not import this skill',
      emptyImport: 'Choose a SKILL.md file',
      pickerHint: 'Click templates to overlay on the film director, up to 3.',
      pickerHintNone: 'No film spine. Still only AutoDL.art H3 and Codex imagegen.',
      pickerHintAuthor: 'This turn only writes a director skill. Switch back to Film and click the chip. Do not generate video.',
      templates: {
        'director-guzhuang': 'Period',
        'director-cinematography': 'Camera',
        'director-performance': 'Performance',
        'director-sound': 'Sound',
        'director-action': 'Action',
        'director-art-design': 'Art',
        'director-staging': 'Staging',
        'director-consistency': 'Continuity',
